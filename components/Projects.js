...
const Projects = () => {
  ...
  return (
    <section id="projects" className="py-20 px-6 max-w-7xl mx-auto mb-20">
            ...
            <div className="p-6 flex flex-col flex-grow">
              ...
              <div className="mt-auto pt-4 border-t border-[#491D04]/10 flex items-center justify-between">
                ...
                <button 
                  ...
                  className="cursor-pointer text-sm font-bold text-[#491D04] hover:text-[#FFD065] transition-colors flex items-center gap-2 group/btn"
                >
                  Voir le projet
                  {/* Icône Oeil */}
                  <svg 
