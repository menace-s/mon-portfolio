      ...
      <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center z-10">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto">
            ...
            <Link 
              href="#projects"
              // CORRECTION ICI : hover:scale-105 au lieu de translate. C'est beaucoup plus doux.
              className={`px-8 py-4 rounded-full font-bold text-[#491D04] border-2 border-[${darkColor}] shadow-[4px_4px_0px_0px_${darkColor}] hover:scale-105 active:scale-95 transition-transform duration-200 text-center`}
              style={{
            ...
            <Link 
              ...
              className={`px-8 py-4 rounded-full font-bold text-gray-700 bg-white border-2 border-[${darkColor}] shadow-[4px_4px_0px_0px_${darkColor}] hover:scale-105 active:scale-95 transition-transform duration-200 text-center`}
            >
              Me contacter
            </Link>
          </div>
